...
namespace Muc.Editor.Internal {
  ...
  internal static class SubassetUtility {
    ...
    public static bool DoesReferenceSubassets(this SerializedProperty property) {
    ...
    private static void AddReferencedSubassets(HashSet<Object> referencedSubassets, Object[] allSubassets, Object asset) {
      ...
      foreach (var child in children)
        AddReferencedSubassets(referencedSubassets, allSubassets, child);
    }

    private static void AddReferencedSubassets(HashSet<Object> referencedSubassets, Object[] allSubassets, SerializedProperty property) {
      if (property.propertyType == SerializedPropertyType.ObjectReference) {
        AddReferencedSubassets(referencedSubassets, allSubassets, property.objectReferenceValue);
      } else {
