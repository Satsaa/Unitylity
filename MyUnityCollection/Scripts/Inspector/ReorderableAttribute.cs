...
// Original: https://github.com/cfoulston/Unity-Reorderable-List
...
namespace MUC.Inspector {
  ...
  [DefaultMember("Item")]
  [Serializable]
  public class ReorderableArray<T> : List<T> { }
}
...
namespace MUC.Inspector.Internal {
  ...
  public class ReorderableDrawer : PropertyDrawer {
    ...
    public static ReorderableList GetList(SerializedProperty property, string arrayPropertyName) => GetList(property, null, GetListId(property), arrayPropertyName);
    public static ReorderableList GetList(SerializedProperty property, int id, string arrayPropertyName) => GetList(property, null, id, arrayPropertyName);
    public static ReorderableList GetList(SerializedProperty property, ReorderableAttribute attrib, string arrayPropertyName) => GetList(property, attrib, GetListId(property), arrayPropertyName);
