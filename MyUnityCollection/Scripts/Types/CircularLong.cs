...
namespace Muc.Types {
  ...
  public readonly struct CircularLong {
    ...
    public readonly long ceiling;

    public static CircularLong operator +(CircularLong a, long b) => new CircularLong(a.value + b, a.ceiling);
    public static CircularLong operator ++(CircularLong a) => new CircularLong(a.value + 1, a.ceiling);
    public static CircularLong operator -(CircularLong a, long b) => new CircularLong(a.value - b, a.ceiling);
    public static CircularLong operator --(CircularLong a) => new CircularLong(a.value - 1, a.ceiling);
