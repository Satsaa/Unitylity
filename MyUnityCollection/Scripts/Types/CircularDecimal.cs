...
namespace Muc.Types {
  ...
  public readonly struct CircularDecimal {
    ...
    public readonly decimal ceiling;

    public static CircularDecimal operator +(CircularDecimal a, decimal b) => new CircularDecimal(a.value + b, a.ceiling);
    public static CircularDecimal operator ++(CircularDecimal a) => new CircularDecimal(a.value + 1m, a.ceiling);
    public static CircularDecimal operator -(CircularDecimal a, decimal b) => new CircularDecimal(a.value - b, a.ceiling);
    public static CircularDecimal operator --(CircularDecimal a) => new CircularDecimal(a.value - 1m, a.ceiling);
    ...
    public CircularDecimal(decimal value, decimal threshold) {
      ...
      if (threshold <= 0m) throw new System.ArgumentOutOfRangeException($"{threshold} is less than one", nameof(threshold));
