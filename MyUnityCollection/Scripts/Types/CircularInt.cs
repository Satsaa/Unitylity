...
namespace Muc.Types {
  ...
  public readonly struct CircularInt {
    ...
    public static CircularInt operator +(CircularInt a, int b) => new CircularInt(a.value + b, a.ceiling);
    public static CircularInt operator ++(CircularInt a) => new CircularInt(a.value + 1, a.ceiling);
    public static CircularInt operator -(CircularInt a, int b) => new CircularInt(a.value - b, a.ceiling);
    public static CircularInt operator --(CircularInt a) => new CircularInt(a.value - 1, a.ceiling);
