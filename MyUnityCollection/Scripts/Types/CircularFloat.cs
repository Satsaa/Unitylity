...
namespace Muc.Types {
  ...
  public readonly struct CircularFloat {
    ...
    public static CircularFloat operator +(CircularFloat a, float b) => new CircularFloat(a.value + b, a.ceiling);
    public static CircularFloat operator ++(CircularFloat a) => new CircularFloat(a.value + 1f, a.ceiling);
    public static CircularFloat operator -(CircularFloat a, float b) => new CircularFloat(a.value - b, a.ceiling);
    public static CircularFloat operator --(CircularFloat a) => new CircularFloat(a.value - 1f, a.ceiling);
